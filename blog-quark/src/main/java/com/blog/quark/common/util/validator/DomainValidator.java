package com.blog.quark.common.util.validator;
...
public class DomainValidator implements Serializable{
	...
	private static final long serialVersionUID = -5951441158889121788L;
    ...
    */
    ...
    public boolean isValid(String domain) {
        ...
        return allowLocal && hostnameRegex.isMatch(domain);
    }
...
//        "aigo", // aigo aigo Digital Technology Co,Ltd. [Not assigned as of Jul 25]
        ...
        "pay", // pay Alibaba Group Holding Limited
...
//        "tp",                 // East Timor (Retired)
    ...
    private static class IDNBUGHOLDER {
        private static boolean keepsTrailingDot() {
            String input = "a."; // must be a valid name
